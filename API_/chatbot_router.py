...
This router handles:
- POST /chat â€” Chat interactions with the AI assistant
- GET /chat/history/{conversation_id} â€” Conversation history retrieval
- DELETE /chat/history/{conversation_id} â€” Clear conversation history
- GET /chat/status â€” Chatbot status checks
...
from api.chatbot_service import get_chatbot_service

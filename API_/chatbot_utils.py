...
# ============================================================================
# ENVIRONMENT LOADING â€” Load .env before any Gemini initialization
# ============================================================================
...
# ============================================================================
# FALLBACK RESPONSES â€” Used when Gemini API is unavailable
# ============================================================================
...
FALLBACK_RESPONSES = {
    "ic50": (
        ...
        "âš ï¸ Note: The Gemini AI service is currently unavailable. This is a pre-defined response. "
    ...
    "recommendation": (
        ...
        "then ranks them using the formula: score = 1/(1+IC50). Lower IC50 â†’ higher score â†’ "
    ...
    "general": (
        ...
        "âš ï¸ This tool is for educational and research purposes only. It does not provide medical advice."
    ),
}

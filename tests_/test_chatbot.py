"""
Tests for the ChatbotService â€” Core service logic.
...
from api.chatbot_service import ChatbotService, get_chatbot_service
from api.chatbot_memory import ConversationMemory
from api.chatbot_utils import FALLBACK_RESPONSES, match_fallback_topic
from api.chatbot_schema import (
    ChatRequest,
    ChatResponse,
    ChatMessage,
    ChatHistoryResponse,
...
class TestChatbotService:
    ...
    @patch('api.chatbot_service.ChatbotService._initialize_gemini')
